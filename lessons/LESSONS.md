...
| 2026-08-14 | `library.lt.js` hand-edited | LT JS is generated from `LT_JS_PAIRS` in [scripts/generate-et-lv-pages.cjs](../scripts/generate-et-lv-pages.cjs). Same for `library.{et,lv,de}.js`. | [locale-sync](../.cursor/skills/locale-sync/SKILL.md) |
