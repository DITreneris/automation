---
name: locale-sync
description: Sync ET/LV/LT from EN after en/index.html, en/privacy.html, or js/library.js changes. Run generate:et-lv and manual LT/JA/ZH checklist.
---
...
10. If new URLs or hreflang: check `sitemap.xml` and [docs/MULTILINGUAL_STRUCTURE.md](docs/MULTILINGUAL_STRUCTURE.md).
...
`en/`, `js/library.js`, `scripts/generate-et-lv-pages.cjs`, `scripts/prompt-bodies-et-lv.cjs`, `scripts/prompt-bodies-zh.cjs`, `docs/MULTILINGUAL_STRUCTURE.md`
