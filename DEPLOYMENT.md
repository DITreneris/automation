...
Locale keliai: `/`, `/lt/`, `/en/`, `/et/`, `/lv/`, `/de/`, `/ja/`, `/zh/` ir atitinkami privatumo puslapiai.
...
| Neteisingas locale kelias | Root deploy – base path `''`. Svetainė turi `/lt/`, `/en/`, `/et/`, `/lv/`, `/de/`, `/ja/`, `/zh/`; root redirect numatytai į `/en/`. |
