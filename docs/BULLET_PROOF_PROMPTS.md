...
**UI:** Į mainų atmintinę kopijuojamas tik META+INPUT+OUTPUT. **Copy CTA** (`.prompt-footer`) – iškart po code-block; instrukcijos (Naudok kai, Pakeisk prieš naudodamas, Ką daryti) – atskirame „Prieš naudojant“ bloke žemiau; info-box (Readiness) – paskutinis.
