...
- `npm run lint:html` → `node scripts/lint-html.mjs`. ESLint: `lucide` globalas `library*.js` ([.eslintrc.json](.eslintrc.json)). Struktūriniai testai: `library.css`, locale JS failai.
